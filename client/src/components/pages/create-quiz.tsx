    ...
    const cards = [
        {
            ...
            info:"In this type you only have four options to set for your students  ,so have fun 😊😊 ",
            path:"/quiz/multichoice"    ,
            imgid:1   
        },
        {
            title:"True or False",
            info:"This is a ture or false question you can set questions that can be answered on the basis of true of false ",
            path:"/quiz/trueorfalse",
            imgid:2
        },
        {
            title:"Short answer question",
            info:"This mode questions are answered in summary there are no options ",
            path:"/quiz/saq",
            imgid:3
        }
