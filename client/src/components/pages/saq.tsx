      ...
      <div className="md:flex md:items-center md:gap-12">
          ...
          >
            ...
            <div className="p-2">
              <form  action="#">
               ...
               <h1 className="text-center font-bold m-[10px] text-3xl">Short answer question setter</h1>
       ...
       Submit Questions
                 ...
                 <div>Input Answer</div>
                    ...
                    onChange={(e:React.ChangeEvent<HTMLInputElement>)=> setstage({...stage,answer:e.target.value})}
