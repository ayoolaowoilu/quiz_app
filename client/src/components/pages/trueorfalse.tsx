        ...
        <div onClick={()=>{
          ...
          >
            ...
            <div className="p-2">
               ...
               {not ? <div
                className={msg?.includes("##") ? " fixed top-[60px] w-full p-[10px] bg-red-50 text-red-700" : "w-full fixed top-[60px] p-[10px] bg-green-50 text-green-700"}>
                 {msg}
                </div> : null}
               <h1 className="text-center font-bold m-[10px] text-3xl">True or False question setter</h1>
               ...
               <div>
                ...
                {loading ? <button
                 ...
                 <div>Input Answer</div>
                    ...
                    onChange={(e:React.ChangeEvent<HTMLSelectElement>)=> setstage({...stage,answer:e.target.value})}
                     className=" m-[10px] mx-auto bg-inherit border-4 outline-none w-full rounded-md border-gray-200 bg-white p-3 text-gray-700 shadow-xs transition focus:border-white focus:ring-3 focus:ring-yellow-400 focus:outline-hidden" id="">
