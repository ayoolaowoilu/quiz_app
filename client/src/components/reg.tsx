...
export default function Reg(){
  ...
  const handlesubmit =async(e:FormEvent)=>{
    ...
    setmsg("")
    try {
      const resp = await axios.post(`${import.meta.env.VITE_URL}/auth/reg`,profile)
      console.log(resp)
      setloading(false)
      setnot(true)
...
<div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
  <div className="mx-auto max-w-lg text-center">
    <h1 className="text-2xl font-bold sm:text-3xl">Get started With Hyper Quizes </h1>

    <p className="mt-4 text-gray-500">
     Welcome to hyper quizes , a place where you can learn and make oppoturinuty fo yourself 
    </p>
  </div>
